...
renderer = {
  ...
  populate_artifacts: function(build) {
    ...
    gem_repo_artifact = self.locate_artifact(build, 'assembly/target/stage/gem-repo/simple-index' );
...
j = new Jenkins( renderer, 'http://projectodd.ci.cloudbees.com', 'torquebox', [
